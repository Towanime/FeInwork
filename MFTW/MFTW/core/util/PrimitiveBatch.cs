...
namespace FeInwork.core.util
{
    ...
    // users, in a similar way to SpriteBatch. PrimitiveBatch can render lines, vertices,
    ...
    public class PrimitiveBatch : IDisposable
    {
        ...
        // how many verts does each of these primitives take up? vertices are 1,
        ...
        public PrimitiveBatch(GraphicsDevice graphicsDevice)
        {
            ...
            // projectionDistance uses CreateOrthographicOffCenter to create 2d projectionDistance
        ...
        public void Begin(PrimitiveType primitiveType, Matrix transformMatrix)
        {
            ...
            basicEffect.View = transformMatrix;
